...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   buildBoard: () => (/* binding */ buildBoard),\n/* harmony export */   game: () => (/* binding */ game)\n/* harmony export */ });\n/* harmony import */ var _gameFactory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameFactory */ \"./src/app/gameFactory.js\");\n/* harmony import */ var _insertShip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./insertShip */ \"./src/app/insertShip.js\");\n/* harmony import */ var _userAttack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./userAttack */ \"./src/app/userAttack.js\");\n/* harmony import */ var _pcAttack__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pcAttack */ \"./src/app/pcAttack.js\");\n/* harmony import */ var _placeShips__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./placeShips */ \"./src/app/placeShips.js\");\n\n\n\n\n\nconst board = buildBoard();\nlet userShipNumber = 1;\nlet pcShipNumber = 1;\nfunction game(typeOfOperation, coordinates, orientation) {\n  if (typeOfOperation === 'initialize') {\n    (0,_placeShips__WEBPACK_IMPORTED_MODULE_4__.initializeGame)();\n  }\n  if (typeOfOperation === 'attack-oponent') {\n    (0,_userAttack__WEBPACK_IMPORTED_MODULE_2__.makeUserAttack)(board, coordinates);\n  }\n  if (typeOfOperation === 'receive-attack') {\n    (0,_pcAttack__WEBPACK_IMPORTED_MODULE_3__.makePcAttack)(board);\n  }\n  if (typeOfOperation === 'insert-user-ship') {\n    try {\n      (0,_insertShip__WEBPACK_IMPORTED_MODULE_1__.insertShip)(board.user, userShipNumber++, coordinates, orientation);\n      return true;\n    } catch (error) {\n      userShipNumber--;\n      //console.log(error)\n      return false;\n    }\n  }\n  if (typeOfOperation === 'insert-computer-ship') {\n    try {\n      (0,_insertShip__WEBPACK_IMPORTED_MODULE_1__.insertShip)(board.computer, pcShipNumber++, coordinates, orientation);\n      return true;\n    } catch (error) {\n      pcShipNumber--;\n      //console.log(error)\n      return false;\n    }\n  }\n  if (typeOfOperation === 'return-board') {\n    return board;\n  }\n}\nfunction buildBoard() {\n  return {\n    user: (0,_gameFactory__WEBPACK_IMPORTED_MODULE_0__.gameboard)(),\n    computer: (0,_gameFactory__WEBPACK_IMPORTED_MODULE_0__.gameboard)()\n  };\n}\n\n//# sourceURL=webpack://battleship/./src/app/game.js?");
